...
public class Tess {
    ...
    // public static void processImg(BufferedImage inputImage, float scaleFactor,
    // float offset,
    ...
    // // of input image
    // BufferedImage outputImage = new BufferedImage(1050, 1024,
    // inputImage.getType());
    ...
    // inputImage = ImageHelper.rotateImage(inputImage,
    // -imageDeskew1.getSkewAngle());
    // finalOutputimage = ImageHelper.rotateImage(outputImage,
    // -imageDeskew2.getSkewAngle());
